...
public class MessageSender {
    ...
    public void syncSend() {
         ...
         * 参数3： 超时时间 毫秒
         */
        SendResult result = rocketMQTemplate.syncSend("test_topic_a:TagA", "这是一条同步消息", 10000);
    ...
    public void asyncSend() throws Exception {
         ...
         * 参数3： 回调对象
         */
        rocketMQTemplate.asyncSend("test_topic_a:TagA", "这是一条异步消息", new SendCallback() {
            @Override
    ...
    public void sendOneWay() {
         ...
         * 参数2:  消息体 可以为一个对象
         */
        rocketMQTemplate.sendOneWay("test_topic_a:TagA", "这是一条单向消息");
    }
    ...
    public void sendOneWayOrderly() {
         ...
         * 参数2:  消息体 可以为一个对象
         */
        rocketMQTemplate.sendOneWayOrderly("test_topic_a:TagA", "这是一条顺序消息", "8888");
    }
